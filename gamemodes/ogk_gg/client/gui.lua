...
AddRemoteEvent("OGKGG:NotifyPlayerWin", function(winner, x, y, z)
	ThrowFirework(x, y, z)
	OpenScoreboard()
...
function OpenScoreboard()
	CallRemoteEvent("OGKGG:GetScoreBoardData")
...
AddEvent("OMG:OGKGG:OnKeyPress", OnKeyPress)
...
AddEvent("OMG:OGKGG:OnKeyRelease", OnKeyRelease)

function OnPlayerSpawn(playerid)
	SetWebVisibility(scoreboard, WEB_HIDDEN)
end
AddEvent("OMG:OGKGG:OnPlayerSpawn", OnPlayerSpawn)
...
AddEvent("OMG:OGKGG:OnPackageStart", OnPackageStart)
