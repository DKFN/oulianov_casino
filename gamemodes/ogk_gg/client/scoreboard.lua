...
function ScoreboardInit() 
	...
	LoadWebFile(scoreboard, "http://asset/oulianov_casino/gamemodes/ogk_gg/gui/scoreboard.html")
...
-- Server Sent Events
AddRemoteEvent("OGKGG:SetScoreBoardData", function(servername, players, map_name) 
