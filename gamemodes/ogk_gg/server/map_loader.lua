...
local function CreateMapEditorObject(player, modelid, x, y, z, rx, ry, rz, sx, sy, sz, dimension)
...
local function LoadMapFromIni(FileName, dimension)
	...
	for i=1, numobjects do
		...
		if CreateMapEditorObject(1, modelid, x, y, z, rx, ry, rz, sx, sy, sz, dimension) ~= false then
...
AddEvent("BlueMountainsIO:MapLoader:LoadIni", LoadMapFromIni)
